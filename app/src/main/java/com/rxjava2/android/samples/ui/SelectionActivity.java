...
import com.rxjava2.android.samples.ui.Room.Botones;
import com.rxjava2.android.samples.ui.color.ColorActivity;
...
public class SelectionActivity extends AppCompatActivity {
    ...
    public void startColorPrueba(View view) {
        startActivity(new Intent(SelectionActivity.this, ColorActivity.class));
    }

    public void startBaseDeDatos(View view) {
        startActivity(new Intent(SelectionActivity.this, Botones.class));
    }
}
