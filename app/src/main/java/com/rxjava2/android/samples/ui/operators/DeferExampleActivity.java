...
public class DeferExampleActivity extends AppCompatActivity {
    ...
    private void doSomeWork() {
        ...
        Observable<Car> prueba = Observable.defer(() -> Observable.just(car));

//        Observable.defer(() -> Observable.just(car));
        ...
        prueba.subscribe(car1 -> textView.append("auto es " + car.getBrand()));
